...
import '../qr_templates/calendar_event_template.dart';

/// Partially implements the iCalendar format's "VEVENT" format for specifying a
/// calendar event. See RFC 2445. This supports SUMMARY, LOCATION, GEO, DTSTART and DTEND fields.
///
/// @author Sean Owen
class CalendarEventTemplateParser
    extends TemplateParser<CalendarEventTemplate> {
  const CalendarEventTemplateParser();
  @override
  CalendarEventTemplate? parse(String rawText) {
  ...
  static String? _matchSingleVCardPrefixedField(String prefix, String rawText) {
    final values = ContactInfoTemplateParser.matchSingleVCardPrefixedField(
      prefix,
      rawText,
      true,
      false,
  ...
  static List<String>? _matchVCardPrefixedField(String prefix, String rawText) {
    final values = ContactInfoTemplateParser.matchVCardPrefixedField(
