...
import '../qr_templates/wifi_template.dart';
...
/// @author Sean Owen
/// @author Steffen Kieß
class WifiTemplateParser extends TemplateParser<WifiTemplate> {
  const WifiTemplateParser();

  @override
  WifiTemplate? parse(String rawText) {
