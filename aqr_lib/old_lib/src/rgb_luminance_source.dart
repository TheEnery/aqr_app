...
class RGBLuminanceSource {
  ...
  RGBLuminanceSource.orig(this._width, this._height, this._luminances)
      : _dataWidth = _width,
        _dataHeight = _height,
        _left = 0,
        _top = 0;

  RGBLuminanceSource(this._width, this._height, List<int> pixels)
      : _dataWidth = _width,
        _dataHeight = _height,
        _left = 0,
        _top = 0,
  ...
  RGBLuminanceSource._(
    ...
    int? width,
    int? height,
  ])  : _width = width ?? _dataWidth,
        _height = height ?? _dataHeight {
  ...
  RGBLuminanceSource crop(int left, int top, int width, int height) =>
      RGBLuminanceSource._(
        _luminances,
        _dataWidth,
        _dataHeight,
