...
class ECBlocks {
  ...
  ECBlocks(this._ecCodewordsPerBlock, this._ecBlocks);

  int get ecCodewordsPerBlock => _ecCodewordsPerBlock;
  ...
  int get totalECCodewords => _ecCodewordsPerBlock * numBlocks;
...
class ECB {
  ...
  int get dataCodewords => _dataCodewords;
}
...
class Version {
  ...
  List<int> get alignmentPatternCenters => _alignmentPatternCenters;

  int get totalCodewords => _totalCodewords;

  int get dimensionForVersion => 17 + 4 * _versionNumber;
