...
import 'package:zxing_lib/src/core/bit_reader.dart';

/// Encapsulates the result of decoding a matrix of bits.
///
/// This typically applies to 2D barcode formats. For now it contains
/// the raw bytes obtained, as well as a String interpretation of those bytes, if applicable.
///
/// @author Sean Owen
class DecoderResult {
  final BitReader? _rawBytes;
  ...
  BitReader? get rawBytes => _rawBytes;
